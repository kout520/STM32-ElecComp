...
void OLEDINIT(void)
{
    ...
    //OLED_ShowStr(0,0,"  ",2);
    OLED_ShowCN(16, 2, 2); // 从坐标 (0,0) 开始，显示 2 个中文字符
    OLED_ShowCN(32, 2, 3); // 从坐标 (0,0) 开始，显示 2 个中文字符
    OLED_ShowStr(48,2,":",2);

    
    OLED_ShowCN(16, 4, 4); // 从坐标 (0,0) 开始，显示 2 个中文字符
    OLED_ShowCN(32, 4, 5); // 从坐标 (0,0) 开始，显示 2 个中文字符    
